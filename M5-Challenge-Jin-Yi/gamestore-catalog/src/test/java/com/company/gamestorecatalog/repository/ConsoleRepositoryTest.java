...
public class ConsoleRepositoryTest {
        ...
        public void shouldFindConsoleByManufacturer(){
            ...
            //Act
            List<Console> foundNoConsole = consoleRepository.findConsoleByManufacturer("InvalidManufacturer");

            List<Console> foundOneConsole = consoleRepository.findConsoleByManufacturer("Sega");

            List<Console> foundTwoConsole = consoleRepository.findConsoleByManufacturer("PS-IV");
