...
public class InvoiceRepositoryTest {
    ...
    public void shouldAddFindDeleteInvoice() {
        ...
        tShirt1 = client.saveTShirt(tShirt1);
        ...
        String stateS = invoice1.getState();
        ...
        invoice1.setTax(tempTaxRate.multiply(invoice1.getSubtotal()));

//        Optional<Tax> tax = Optional.ofNullable(taxRepository.findByState(invoice1.getState());
