...
//
//        service = new GameStoreServiceLayer(client, invoiceRepository, taxRepository, processingFeeRepository);
//    }
...
//
////        verify(client.getConsoleById(console2.getId()), times(2)).saveConsole(any(Console.class));
//
//    }
//
//    @Test(expected = IllegalArgumentException.class)
