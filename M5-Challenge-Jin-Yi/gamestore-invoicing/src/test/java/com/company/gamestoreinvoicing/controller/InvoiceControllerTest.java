...
public class InvoiceControllerTest {
    ...
    public void shouldFindInvoicesByCustomerName() throws Exception{
        ...
        foundAllInvoices.add(savedInvoice1);
        foundAllInvoices.add(savedInvoice3);
        System.out.println(foundAllInvoices);

        String outputJson = mapper.writeValueAsString(foundAllInvoices);
        //due to the quality constraints these invoices cannot be added
//
//        //Mock call to service layer...
//        doReturn(foundAllInvoices).when(this.storeServiceLayer).getInvoicesByCustomerName("Sandy Beach");
//
//        //Act & Assert
//        this.mockMvc.perform(get("/invoice/cname/Sandy Beach"))
//                .andDo(print())
//                .andExpect(status().isOk())
//                .andExpect(content().json(outputJson));
